...
const JewelleryTable = () => {
    ...
    // Useselector
    const { loading, fetchJewelleriesData, createJewelleryData, updateJewelleryData, deleteJewelleryData } = useSelector((state: RootState) => ({
            ...
            columnHelper.accessor('jewelleryName', {
                ...
                cell: ({ row }) => (
                    <div className='flex items-center gap-3'>
                        <img src={row.original.images[0] || "https://media.istockphoto.com/id/1276740597/photo/indian-traditional-gold-necklace.jpg?s=2048x2048&w=is&k=20&c=xF4hfQ1TDjt5ft2dSrE5C5CRxQOqjkrukDBkAtg-qkg="} width={38} height={38} className='rounded bg-actionHover' />
            ...
            columnHelper.accessor('actions', {
                ...
                cell: ({ row }) => (
                    <div className='flex items-center'>
                        <OpenDialogOnElementClick element={IconButton} elementProps={iconButtonProps} dialog={AddJewellery} dialogProps={row.original} />
        ...
        <>
            ...
            <Card>
                ...
                <div className='overflow-x-auto'>
                    {loading ? <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', paddingY: 4, }}>
                        <CircularProgress />
                    </Box> : (
                        <>
