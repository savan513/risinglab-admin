...
const CategoryTable = () => {
    ...
    // Useselector
    const { loading, fetchCategoriesData, createCategoryData, updateCategoryData, deleteCategoryData } = useSelector((state: RootState) => ({
    ...
    }, [createCategoryData, updateCategoryData, deleteCategoryData]);
            ...
            columnHelper.accessor('actions', {
                ...
                cell: ({ row }) => (
                    <div className='flex items-center'>
                        <OpenDialogOnElementClick element={IconButton} elementProps={iconButtonProps} dialog={AddCategory} dialogProps={row.original} />
