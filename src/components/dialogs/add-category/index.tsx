            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <DialogContent className='pbs-0 sm:pli-16'>
                    ...
                    <Grid container spacing={6}>
                        ...
                        <Grid size={{ xs: 12 }}>
                            <ProductImage
                                setJewelleryData={setCategoryData}
                                jewelleryData={categoryData}
                            />
                        </Grid>
                    </Grid>
                </DialogContent>
                <DialogActions className='justify-center pbs-0 sm:pbe-16 sm:pli-16'>
                    ...
                    <Button variant='contained' disabled={loading} // Disable button while loading
                        startIcon={loading && <CircularProgress size={20} color="inherit" />}/* onClick={() => setOpen(false)} */ type='submit'>
